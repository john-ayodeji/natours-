      ...
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'SignUp Succesfull');
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 1:
          res = _context2.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Password reset link has been sent to your email, please finish process through the provided link');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(password, passwordConfirm) {
    var tokenArr, resetToken, res, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          tokenArr = window.location.pathname.split('/');
        ...
        case 2:
          res = _context3.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Password changed, you can now login in with your new password');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51RWeTIGGSPrhNowK7NDtvggds4rKKlzMrP2LSDZhvWnwH6OLsQT7agE3IcMNPKq5qMqXoLtakFKRVcK6DjmJTg1E00fgbuNma4');
...
var detailsForm = document.querySelector('.form-user-data');
var passwordForm = document.querySelector('.form-user-settings');
var bookBtn = document.getElementById('book-tour');
var resetForm = document.querySelector('.form--reset-password');
